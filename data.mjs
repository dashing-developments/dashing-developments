...
const DEFAULTS = {
  props: [
    ...
    {id:5,name:"Lancaster Property 3",price:"$340,000",loc:"Lancaster, VA",beds:0,baths:0,sqft:0,type:"Lancaster",status:"Available",desc:"Lancaster County homesite featuring 10' ceilings and 2-car garage options.",photos:[],video:"",hero:false,showcase:true},
  ...
  team: [
    {id:1,name:"Jerry Farzayee",role:"Founder & Licensed General Contractor",email:"jerry@farzayee.com",bio:"Jerry Farzayee is the founder of Dashing Developments LLC and a licensed general contractor focused on custom residential development. He built his own home while acting as his own general contractor before becoming formally licensed, giving him hands-on perspective in planning, budgeting, trade coordination, finishes, and construction quality.",photo:""},
    {id:2,name:"Yousef Farzayee",role:"Project & Construction Manager",email:"",bio:"Yousef Farzayee serves as Project & Construction Manager for Dashing Developments. He is studying construction and focused on project management, field coordination, and day-to-day execution. His role reflects the company's long-term family vision.",photo:""},
  ],
  models: [
    ...
    {id:2,name:"The Lancaster Classic",style:"Lancaster",price:"From $340,000",beds:3,baths:2.5,sqft:1600,garage:"2-Car Garage",desc:"A smart single-story plan designed for our Lancaster County homesites. Modern open concept with 10' ceilings and flexible finishes.",lots:"Lancaster Properties 1-4",photos:[],visible:true},
